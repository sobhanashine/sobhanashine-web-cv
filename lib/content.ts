...
const fa: Content = {
  ...
  about: {
    paragraphs: [
      "مهندس فول‌استک با چهار سال تجربه در طراحی و توسعه‌ی بک‌اندهای مقیاس‌پذیر و پرسرعت با NestJS، Node.js و TypeScript؛ از APIهای REST و GraphQL و مدل‌های داده‌ی رابطه‌ای گرفته تا زیرساخت بلادرنگی که آن‌ها را پشتیبانی می‌کند.",
      "در تمام لایه‌های استک تسلط دارم: از معماری‌های Headless، سیستم‌های WebSocket و یکپارچه‌سازی درگاه‌های پرداخت و OAuth تا قابلیت‌های هوش مصنوعی بر بستر OpenAI — و در نهایت فرانت‌اندهای سریع و بهینه برای سئو با Next.js، Nuxt و Vue که کاربر مستقیماً با آن‌ها سروکار دارد.",
      "به کدِ تمیز و آزمون‌شده پایبندم و از تبدیلِ نیازمندی‌های مبهم به سیستم‌هایی که در محیط واقعی پایدار و قابل‌اتکا می‌مانند، لذت می‌برم.",
    ],
    facts: [
  ...
  experience: [
    {
      ...
      url: "https://droplinked.com",
      summary:
        "توسعه‌ی بک‌اند یک پلتفرم تجارت مبتنی بر Web3 — شامل پرداخت، احراز هویت و مجموعه‌ای از قابلیت‌های هوش مصنوعی برای فروشندگان.",
      highlights: [
        "بازطراحی ماژول‌های اصلی بر پایه‌ی معماری Use-Case محور و بهینه‌سازی کوئری‌ها، تا ۹۰٪ بهبود کارایی.",
        "پیاده‌سازی کاملِ درگاه پرداخت PayPal به‌صورت سرتاسری (End-to-End)، شامل فرایند ثبت‌نام فروشندگان.",
        "افزودن ورود امن و یکپارچه با Google OAuth برای فروشندگان و مشتریان.",
        "توسعه‌ی یک دستیار هوش مصنوعی مبتنی بر GPT و بک‌اندِ یک ایجنت هوشمند برای تولید خودکارِ توضیحات محصول، مقالات بلاگ و محتوای فروشگاه.",
        "طراحی یک جریان پشتیبانی هوشمند که در صورت کافی‌نبودنِ اتوماسیون، درخواست را به‌صورت خودکار از طریق ایمیل به کارشناس انسانی ارجاع می‌دهد.",
      ],
      stack: ["NestJS", "TypeScript", "OpenAI", "PayPal", "OAuth"],
    },
    {
      ...
      summary:
        "راهبری بخش بک‌اند در پروژه‌های متعدد مشتریان بر بستر اکوسیستم NestJS، به‌همراه توسعه‌ی فول‌استک با Nuxt.js.",
      highlights: [
        "راهبری سرویس‌های بک‌اند برای طیف متنوعی از پروژه‌های مشتریان و توسعه‌ی فرانت‌اند با Nuxt.js در نقش فول‌استک.",
        "طراحی احراز هویت امن مبتنی بر توکن (JWT) و کنترل دسترسی با Passport.js.",
        "طراحی و نگه‌داری APIهای REST پایدار و اسکیمای PostgreSQL با Prisma.",
        "کاهش حدود ۳۰٪ میانگین زمان پاسخ APIها از طریق بهینه‌سازی کوئری و راهکارهای کشینگ.",
    ...
    },
    {
      ...
      summary: "توسعه‌ی رابط‌های کاربری واکنش‌گرا و تعاملی برای محصولات با Vue.js و Nuxt.js.",
      highlights: [
        "توسعه‌ی رابط‌های کاربری واکنش‌گرا و تعاملی برای اپلیکیشن‌های وب با Vue.js و Nuxt.js.",
        "تبدیل طرح‌های UI/UX به کامپوننت‌های باکیفیت و قابل‌استفاده‌ی مجدد.",
        "یکپارچه‌سازی با APIهای بک‌اند در همکاری نزدیک با مهندسان سمت سرور.",
    ...
    },
    {
      ...
      summary:
        "توسعه‌ی فول‌استک روی پلتفرم سلامت دیجی‌مراقب، از پایگاه‌داده تا رابط کاربری.",
      highlights: [
        ...
        "ساخت یک اپلیکیشن وب کامل به‌صورت سرتاسری (End-to-End).",
      ],
      stack: ["React.js", "Nest.js", "PostgreSQL"],
    },
  ] as Experience[],
  ...
  projects: [
    {
      name: "افق",
      index: "P-01",
      tagline: "پلتفرم محتوای Headless و چندزبانه.",
      description:
        "فرانت‌اند جداشده‌ی Next.js روی بک‌اند وردپرس؛ کنترلِ کاملِ رندر، HTML و سئو بر عهده‌ی Next.js است و محتوا از طریق WPGraphQL تأمین می‌شود — چندزبانه میان فارسی، انگلیسی و عربی با پشتیبانی کامل از RTL.",
      contributions: [
        "طراحی معماری Headless با وردپرس و Next.js و دریافت محتوا از طریق یک کلاینت سبکِ WPGraphQL، همراه با SSG/ISR و بازاعتبارسنجی بر اساس درخواست (On-Demand).",
        "پیاده‌سازی کامل چندزبانگی با next-intl (فارسی به‌عنوان زبان پیش‌فرض، به‌علاوه‌ی انگلیسی و عربی) شامل رندر کامل RTL.",
        "نگاشت داده‌های سئوی Yoast / WPGraphQL به Metadata API نکست و تولید JSON-LD مبتنی بر schema.org برای نمایش نتایج غنی (Rich Results).",
        "توسعه‌ی یک Endpoint بازاعتبارسنجی مبتنی بر Webhook تا با هر بار انتشار محتوا توسط ادیتور، صفحات ISR بلافاصله به‌روزرسانی شوند.",
      ],
      stack: ["Next.js", "TypeScript", "WPGraphQL", "Tailwind CSS", "next-intl", "WordPress"],
      url: "https://ofoq-web.vercel.app",
    },
    {
      ...
      contributions: [
        ...
        "طراحی و پیاده‌سازی یک پنل مدیریت قدرتمند روی Supabase برای مدیریت داده‌ها، ذخیره‌سازی و عملیات بک‌اند.",
        "توسعه‌ی یک سامانه‌ی اصالت‌سنجی اختصاصی که اصالت خرید را از طریق کدهای یکتا و به‌صورت مستقیم روی سایت تأیید می‌کند.",
      ],
      stack: ["Next.js", "Supabase", "TypeScript"],
      url: "https://auradisposable.com",
    },
    {
      ...
      contributions: [
        "توسعه‌ی چت بلادرنگ میان بیمار و پزشک با WebSocket.",
        "ساخت Endpointهای API برای ثبت‌نام، مدیریت پروفایل و رزرو نوبت.",
  ...
  ui: {
    ...
    hero: {
      ...
      taglinePost: " پشت صفحه را می‌سازم.",
      nameRoleSep: " — ",
      lead: "بک‌اندهای مقیاس‌پذیر با NestJS و Node، سیستم‌های بلادرنگ و قابلیت‌های هوش مصنوعی — و فرانت‌اندهای سریع و بهینه برای سئو که روبه‌روی کاربر می‌نشینند. {years} سال تجربه، بک‌اندمحور و فول‌استک.",
